...
model = load_model('Capsnet_model/digit_classifier.h5')
...
def predict_digit(img):
    ...
    return output[np.argmax(model.predict(test_image))]
...
def put_label(t_img,label,x,y):
    ...
    l_x = int(x) - 10
    l_y = int(y) + 10
    cv2.rectangle(t_img,(l_x,l_y+5),(l_x+70,l_y-35),(0,255,255),-1) 
